...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/06/16 01:16:42 by ahallain          #+#    #+#             */
/*   Updated: 2020/06/16 01:16:43 by ahallain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const tokens = async html5playerfile => {
	const cachedTokens = cache[html5playerfile];
	if (cachedTokens)
		return cachedTokens;
	const body = await stream.promise(html5playerfile);
